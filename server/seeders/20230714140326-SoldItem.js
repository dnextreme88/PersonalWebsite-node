...
module.exports = {
    up: async (queryInterface) => {
        return queryInterface.bulkInsert('SoldItem', [
            ...
            {
                name: 'Adidas Predito Size 12 Inch Shoes',
                price: 400,
                condition: 'used',
                size: '12',
                dateSold: '2017-12-02',
            ...
            {
                name: 'LG 16M38A-B 15.6 Inch Monitor',
                price: 1300,
                condition: 'new',
                size: '15.6',
                dateSold: '2020-08-01',
            ...
            {
                name: 'LG E1941 18.5 Inch Monitor',
                price: 1000,
                condition: 'new',
                size: 'N/A',
                dateSold: '2022-09-12',
            ...
            },
            {
                ...
                condition: 'used',
                size: 'L',
                notes: 'Payment sent through GCash on 2/7. Buyer picked up on 2/8. Received payment on 2/11.',
                dateSold: '2023-02-05',
                createdAt: new Date(),
                updatedAt: new Date(),
            },
